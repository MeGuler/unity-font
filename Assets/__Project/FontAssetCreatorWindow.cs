...
//{
//        public class FontAssetCreatorWindoww : EditorWindow
//        {
//            [MenuItem("Window/TextMeshPro/Font Asset Creator 2", false, 2025)]
//            public static void ShowFontAtlasCreatorWindow()
//            {
//                var window = GetWindow<FontAssetCreatorWindoww>();
...
//            private List<Object> selectedFontSiblings = new List<Object>();
//            private Object lastFontFile;
//            
//            #region Other
//
//               
...
//
//
//            private IEnumerator GenerateFonts()
//            {
//                 int count = 0;
//
//                 while (count < 2)
////                 while (count < selectedFontSiblings.Count)
//                 {
//                     
//                 #region while
//
...
//                    {
//                        lastFontFile = selectedFontSiblings[count];
//                        DestroyImmediate(m_FontAtlasTexture);
//                        m_FontAtlasTexture = null;
//                        m_SavedFontAtlas = null;
//    
...
//                        string fontPath = AssetDatabase.GetAssetPath(lastFontFile);
//    
//                        if (errorCode == FontEngineError.Success)
//                        {
...
//                            if (errorCode != FontEngineError.Success)
//                            {
//                                Debug.Log("Font Asset Creator - Error Code [" + errorCode + "] has occurred trying to load the [" + lastFontFile.name + "] font file. This typically results from the use of an incompatible or corrupted font file.");
//                            }
//                        }
//    
//    
